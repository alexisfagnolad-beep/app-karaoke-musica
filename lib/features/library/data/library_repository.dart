...
class LibraryRepository extends ChangeNotifier {
  ...
  Future<void> addSong({
    ...
    String? lyricsDest;
    if (lyricsSourcePath != null && File(lyricsSourcePath).existsSync()) {
      lyricsDest = '${media.path}/$id.lyrics.json';
      File(lyricsSourcePath).copySync(lyricsDest);
    }
